...
async function addUser(){
   ...
   try {
      await api.post('getEquipments', formData,
...
async function addEquipment(){
    const formData = new FormData()
    formData.append("name", equipmentName.value +' '+ lastName.value,);
    formData.append("usage", usage.value);
    formData.append("model_no", Number(modelNo.value));
                    ...
                    <v-card>
                        ...
                        <v-card-text>
                            <v-row>
                             ...
                             <v-row>
                                <v-col md="6">
                                    <v-text-field label="Model Number" v-model="modelNo" type="number" required :rules="[rules.required]"></v-text-field>
                                </v-col>
                                <v-col md="6">
